...
import ccc.messengerlock.LockActivity_square;
import ccc.messengerlock.Notif;
import ccc.messengerlock.second_fackActivity;
		...
		th = new Thread(new Runnable() {
			...
			public void run() {
				while (run) {
					...
					Log.d(tag, "p " + flag);
					if (!flag) {
						if (current.contains("com.facebook.orca")) {
