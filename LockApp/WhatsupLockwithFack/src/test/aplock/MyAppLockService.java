...
import ccc.whatsuplock.LockActivity_square;
import ccc.whatsuplock.Notif;
import ccc.whatsuplock.second_fackActivity;
		...
		th = new Thread(new Runnable() {
			...
			public void run() {
				while (run) {
					...
					Log.d(tag, "p " + flag);
					if (!flag) {
						if (current.contains("com.whatsapp")) { // change
