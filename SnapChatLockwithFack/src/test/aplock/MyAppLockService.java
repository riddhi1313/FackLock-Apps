...
import ccc.snapchatlock.LockActivity_square;
import ccc.snapchatlock.Notif;
import ccc.snapchatlock.second_fackActivity;
		...
		th = new Thread(new Runnable() {
			...
			public void run() {
				while (run) {
					...
					Log.d(tag, "p " + flag);
					if (!flag) {
						if (current.contains("com.snapchat.android")) {
