...
public class GalleryListActivity extends Activity implements OnItemClickListener,
		OnClickListener {
	GridView gridView;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		customGridAdapter = new LockThemeAdapter(GalleryListActivity.this, gridArray);
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, final int arg2,
		...
		edit.commit();
		BitmapHelper.saveAssetBG(GalleryListActivity.this, names[arg2]);
		finish();
	}
