...
public class MainActivity extends Activity implements OnCheckedChangeListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Toast.makeText(getApplicationContext(),"width "+w+"height "+h,Toast.LENGTH_LONG).show();
		...
		if(prefs.getBoolean("hide_chap", false)==true)
		{
			...
			ComponentName componentName = new ComponentName(this,
					ccc.instagramlock.StarterActivity.class); 
		...
		belowtxtpasscode = (TextView) findViewById(R.id.belowtxtpasscode);
